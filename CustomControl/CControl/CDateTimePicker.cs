...
namespace CustomControl
{
    public class CDatePicker : DateTimePicker
    {
        ...
        private Image calendarIcon = Properties.Resources.schedule_16px;
        ...
        public Color SkinColor
        {
            ...
            set
            {
                ...
                if(this.ShowUpDown == false)
                {
                    ...
                    else calendarIcon = Properties.Resources.schedule_16px;
                }
                else
                {
                    calendarIcon = Properties.Resources.schedule_16px;
                }
                this.Invalidate();
            }
        }
